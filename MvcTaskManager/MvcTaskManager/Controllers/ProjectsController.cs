...
namespace MvcTaskManager.Controllers
{
    public class ProjectsController : Controller
    {
        ...
        public IActionResult Get()
        {
            ...
            foreach (var project in projects)
            {
                projectsViewModel.Add(new ProjectViewModel()
                {
                    ...
                    DateOfStart = project.DateOfStart.ToString("yyyy-MM-dd"),
        ...
        [HttpGet]
        [Route("api/projects/searchbyprojecid/{ProjectID}")]
        [Authorize(AuthenticationSchemes = JwtBearerDefaults.AuthenticationScheme)]
        ...
        public IActionResult Post([FromBody] Project project)
        {
            ...
            ProjectViewModel projectViewModel = new ProjectViewModel()
            {
                ...
                DateOfStart = existingProject.DateOfStart.ToString("yyyy-MM-dd"),
        ...
        public IActionResult Put([FromBody] Project project)
        {
            ...
            if( existingProject != null )
            {
                ...
                ProjectViewModel projectViewModel = new ProjectViewModel()
                {
                    ...
                    DateOfStart = existingProject2.DateOfStart.ToString("yyyy-MM-dd"),
